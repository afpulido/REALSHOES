-- TABLAS
    ...
    create table tipo_doc(
        tipo_doc_id int primary key IDENTITY(1,1),
        nombre varchar(45),
        descripcion varchar(45),
        fecha_creacion datetime default current_timestamp,
        ultima_modificacion datetime default current_timestamp,
    ...
    create table tipo_persona(
        tipo_persona_id int primary key IDENTITY(1,1),
        nombre varchar(45),
        descripcion  varchar(45),
        fecha_creacion datetime default current_timestamp,
        ultima_modificacion datetime default current_timestamp,
    ...
    create table sede (
        sede_id int primary key IDENTITY(1,1),
        nombre varchar(45),
        direccion varchar(45),
        telefono varchar(45),
        email varchar(45),
    ...
    create table persona_trabaja_sede(
        persona_sede_id int primary key IDENTITY(1,1),
        persona_id int,
        sede_id int,
        fecha_creacion datetime default current_timestamp,
        ultima_modificacion datetime default current_timestamp,
...
-- TRIGGERS
    --TRIGGER QUE INSERTA DATOS ANTIGUOS A LA TABLA ANTIGUO_PERSONA, DESPUES DE UNA ACTUALIZACION EN LA TABLA PERSONA
        GO
        ...
        AS 
        BEGIN
            INSERT INTO antiguo_persona(persona_id,nombre,apellidos,direccion,usuario,contraseña,telefono,email,tipo_doc_id,tipo_persona_id,rol_id,ultima_modificacion)
            SELECT persona_id,nombre,apellidos,direccion,usuario,contraseña,telefono,email,tipo_doc_id,tipo_persona_id,rol_id, GETDATE()
            FROM deleted;
        END;
    
    -- TRIGGER QUE INSERTA SEDE ANTIGUA DE UN EMPLEADO A LA TABLA ANTIGUO_PERSONA_TRABAJA_SEDE, DESPUES DE UNA ACTUALIZACION EN LA TABLA PERSONA_TRABAJA_SEDE
        GO
        CREATE TRIGGER after_update_sede_empleado
        ON persona_trabaja_sede
        FOR UPDATE
        AS
        BEGIN 
            INSERT INTO antiguo_persona_trabaja_sede(persona_id,sede_id,fecha_creacion,ultima_modificacion)
            SELECT persona_id,sede_id,fecha_creacion, GETDATE()
            FROM deleted;
