					...
					<div class="col-lg-7 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								...
								<li><i class="ti-user"></i><a href="?c=Tiendas&a=login">Iniciar sesión</a></li>
								<li><i class="ti-write"></i><a href="?c=Tiendas&a=registrarse">Registrarse</a></li>
								<?php
								...
								<li><i class="ti-lock"></i> <a href="?c=Tiendas&a=cerrarSesion">Cerrar Sesión</a></li>
					...
					<div class="col-lg-3 col-md-3 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar shopping">
								...
								<!-- Shopping Item -->
								<?php include_once 'tienda.listacompra.view.php';?>
								<!--/ End Shopping Item -->
							</div>
						</div>
					</div>
						...
						<div class="col-lg-3">
							<div class="all-category">
								...
								<ul class="main-category">
									...
									<li class="main-mega"><a href="?c=Tiendas&a=damas">Damas</a></li>
