					...
					<div class="col-lg-7 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								...
								<li><i class="ti-user"></i><a href="?id=Logins">Iniciar sesión</a></li>
								<li><i class="ti-write"></i><a href="?id=Registros">Registrarse</a></li>
								<?php
								...
								?>
								<li><i class="ti-desktop"></i> <a href="?id=Dashboard">Dashboard</a></li>
								<li><i class="ti-lock"></i> <a href="?id=Tiendas&t=cerrarSesion">Cerrar Sesión</a></li>
