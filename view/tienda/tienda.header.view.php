				...
				<div class="row">
					...
					<div class="col-lg-7 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								<li><i class="ti-face-smile"></i>Bienvenido! <strong>"Invitado" </strong></li>
								<li><i class="ti-power-off"></i><a href="../../view/tienda/login.view.php">Iniciar sesión</a></li>
								<li><i class="ti-write"></i><a href="../../view/tienda/registro.view.php">Registrarse</a></li>
								<li><i class="ti-user"></i> <a href="../../view/dashboard/dashboard.view.php">Dashboard</a></li>
							</ul>
						</div>
						<!-- End Top Right -->
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="../../view/tienda/tienda.view.php"><img src="../../assets/img/tienda/logo.png" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
								...
								<div class="shopping-item">
									...
									<ul class="shopping-list">
										...
										<li>
											<a href="#" class="remove" title="Remove this item"><i class="fa fa-remove"></i></a>
											<a class="cart-img" href="#"><img src="https://via.placeholder.com/70x70" alt="#"></a>
											<h4><a href="#">Zapatilla Damas</a></h4>
											<p class="quantity">1x - <span class="amount">$35.000</span></p>
										</li>
									</ul>
									<div class="bottom">
										<div class="total">
									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													<li class="active"><a href="tienda.view.php">Inicio</a></li>											
													<li><a href="quienes.view.php">¿Quienes Somos?</a></li>
													<li><a href="contactenos.view.php">contáctenos</a></li>
