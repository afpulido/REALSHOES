					...
					<div class="col-lg-7 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								...
								<li><i class="ti-power-off"></i><a href="../../view/tienda/login.view.html">Iniciar sesión</a></li>
								<li><i class="ti-write"></i><a href="../../view/tienda/registro.view.html">Registrarse</a></li>
								<li><i class="ti-user"></i> <a href="../../view/dashboard/dashboard.view.html">Dashboard</a></li>
							</ul>
						</div>
						<!-- End Top Right -->
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="../../view/tienda.view.html"><img src="../../assets/img/tienda/logo.png" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													...
													<li><a href="#">Compras<i class="ti-angle-down"></i><span class="new">New</span></a>
														<ul class="dropdown">
